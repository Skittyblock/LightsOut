...
@implementation LOHeader

- (id)initWithSpecifier:(PSSpecifier *)specifier {
  self = [super initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"Cell"];

  if (self) {
    NSArray *subtitles = [NSArray arrayWithObjects:@"Toggle with Light Sensor!", @"By Skitty", @"Free and Open-Source!", nil];
